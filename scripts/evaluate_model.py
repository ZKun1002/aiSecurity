...
if __name__ == "__main__":
    # 指定数据目录、模型路径和输出目录
    data_dir = os.path.abspath('../data/processed_cv')  # 测试数据目录
    model_path = os.path.abspath('../models/random_forest_cv_model.pkl')  # 训练好的模型路径
    output_dir = os.path.abspath('../results_cv')
